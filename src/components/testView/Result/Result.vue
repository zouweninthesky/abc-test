...
<template>
  <div class="result">
    <!-- <img class="result__bg" src="@/assets/img/bg-main.jpg" alt="" /> -->
    <div class="result__container">
      <img
        src="@/assets/img/bg-lightning.png"
        alt=""
        class="result__lightning"
      />
      <img
        src="@/assets/img/bg-lightning.png"
        alt=""
        class="result__lightning result__lightning--left"
      />
      <h2 class="result__header">Ваш результат рассчитан:</h2>
      ...
      <p class="result__encourage">Скорее получите свой результат!</p>
...
<style lang="scss">
@import "@/components/testView/Result/Result.scss";
</style>
